...
namespace ConAppBankAccount
{
    internal class Program
        ...
        class BankAccount
        {
            ...
            {
                // Generate a unique account number (you may implement your logic for generating a unique number)
                AccountNumber = GenerateAccountNumber();
                AccountHolderName = accountHolderName;
                Balance = 50000;
            }

            // Method to generate a unique account number (you may implement your logic)
